...
// a thing that would make this more clear is if i could export the setters for loading and error from the other hook
...
export const useEmailPasswordConfirm = (callback?: () => void) => {
	...
	const signupObject: AuthReturnType<EmailPasswordConfirmDataType> = [
		...
		{ email, password, confirmation, onSignup },
	];
